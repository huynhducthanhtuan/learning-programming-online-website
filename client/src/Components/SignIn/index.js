        ...
        <form className={styles.form} id="form-1">
            <img src="./icons/LPO.png" className={styles.logo}></img>
                ...
                <div className={styles.formGroup}>
                    ...
                    <input className={styles.formControl} type="email"  placeholder="Enter email" onChange={handleChange('email')} />

                </div>

                <div className={styles.formGroup}>
                    <label className={styles.formLabel}>Password</label>
                    <input className={styles.formControl} type="password" placeholder="Enter password" onChange={handleChange('password')}  />
                </div>
                ...
                <button type="button" className={`${styles.formSubmit}`} onClick={submitForm}>Sign in</button>
            </form>  
        )  
    } 
