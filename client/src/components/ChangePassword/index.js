...
const ChangePassword = () => {
  ...
  const showHideOldPasswordButton = useRef();
  const showHideNewPasswordButton = useRef();
  const showHideNewPasswordConfirmButton = useRef();
      ...
      <form className={styles.form}>
        ...
        <div className={styles.inputPartFrame}>
          ...
          <button
            ...
            ref={showHideOldPasswordButton}
          >
            <svg fill="none" viewBox="0 0 20 12" className={styles.showIcon}>
              <path
                stroke="none"
                fill="#000"
                fillOpacity=".54"
            ...
            <svg fill="none" viewBox="0 0 20 10" className={styles.hideIcon}>
              <path
                stroke="none"
                fill="#000"
                fillOpacity=".54"
        ...
        <div className={styles.inputPartFrame}>
          ...
          <button
            className={styles.showHidePasswordButton}
            ref={showHideNewPasswordConfirmButton}
          >
            <svg fill="none" viewBox="0 0 20 12" className={styles.showIcon}>
              <path
                stroke="none"
